    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-2 mt-4">
                <div className="">
                    <button className="flex items-center gap-1 btn w-full"><FaGoogle></FaGoogle> Login wiht Google</button>
                </div>
                <div className="">
                    <button className="flex items-center gap-1 btn w-full"><FaGithub></FaGithub> Login with Github</button>
                </div>
            </div>
